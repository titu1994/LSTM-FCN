...
if __name__ == "__main__":
    ...
    #train_model(model, DATASET_INDEX, dataset_prefix='insect_wingbeat_sound', epochs=1000, batch_size=128)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='insect_wingbeat_sound', batch_size=128)

    # visualize_context_vector(model, DATASET_INDEX, dataset_prefix='insect_wingbeat_sound', visualize_sequence=True,
    #                          visualize_classwise=True, limit=1)

    # visualize_cam(model, DATASET_INDEX, dataset_prefix='insect_wingbeat_sound', class_id=0)
