...
if __name__ == "__main__":
    ...
    train_model(model, DATASET_INDEX, dataset_prefix='uwave_gesture_library_x', epochs=100, batch_size=64,
                normalize_timeseries=False)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='uwave_gesture_library_x', batch_size=64)
