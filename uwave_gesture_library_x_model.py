...
if __name__ == "__main__":
    ...
    #train_model(model, DATASET_INDEX, dataset_prefix='uwave_gesture_library_x', epochs=500, batch_size=128,)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='uwave_gesture_library_x', batch_size=128)

    visualise_attention(model, DATASET_INDEX, dataset_prefix='uwave_gesture_library_x', layer_name='attention_dense_1')
