...
from keras.layers import Input, PReLU, Dense, LSTM, multiply, concatenate, Activation, Bidirectional
...
def generate_model_2():
    ...
    x = LSTM(256, trainable=TRAINABLE)(x)
    x = Dropout(0.8)(x)
...
if __name__ == "__main__":
    ...
    #train_model(model, DATASET_INDEX, dataset_prefix='lighting7', epochs=3000, batch_size=32,
    #            cutoff='pre')

    evaluate_model(model, DATASET_INDEX, dataset_prefix='lighting7', batch_size=32,
                   cutoff='pre')

    #visualise_attention(model, DATASET_INDEX, dataset_prefix='lighting7',  layer_name='attention_dense_1',
    #                    cutoff='pre')
