...
TRAIN_FILES = ['../data\\Adiac_train__4_true.csv', # 0
               ...
               '../data\\ECG200_train__4_true.csv',  # 12
...
TEST_FILES = ['../data\\Adiac_test__4_true.csv', # 0
              ...
              '../data\\ECG200_test__4_true.csv', # 12
...
MAX_NB_WORDS_LIST = [4095, 4095, 4095, 4093, 4093, 4095, 4095, 4095, 4095, 4095, 4095, 4095, 4093, 4095, 4095, 4095, 16]

MAX_SEQUENCE_LENGTH_LIST = [167, 242, 461, 503, 503, 568, 119, 277, 336, 71, 71, 71, 87, 127, 341, 122, 14]
