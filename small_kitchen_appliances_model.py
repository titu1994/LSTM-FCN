...
if __name__ == "__main__":
    ...
    # visualize_context_vector(model, DATASET_INDEX, dataset_prefix='small_kitchen_appliance', visualize_sequence=True,
    #                          visualize_classwise=True, limit=1)

    # visualize_cam(model, DATASET_INDEX, dataset_prefix='small_kitchen_appliance', class_id=0)
