...
def generate_model_2():
    ...
    x = LSTM(128, trainable=TRAINABLE)(x)
...
if __name__ == "__main__":
    ...
    #train_model(model, DATASET_INDEX, dataset_prefix='coffee', epochs=500, batch_size=64)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='coffee', batch_size=32)

    visualise_attention(model, DATASET_INDEX, dataset_prefix='coffee', layer_name='attention_dense_1')

    visualize_cam(model, DATASET_INDEX, dataset_prefix='coffee', class_id=0)
