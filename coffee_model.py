...
if __name__ == "__main__":
    ...
    train_model(model, DATASET_INDEX, dataset_prefix='coffee', epochs=1000, batch_size=128)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='coffee', batch_size=128)
