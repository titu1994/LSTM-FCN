...
if __name__ == "__main__":
    ...
    evaluate_model(model, DATASET_INDEX, dataset_prefix='herring', batch_size=128)

    #visualise_attention(model, DATASET_INDEX, dataset_prefix='herring', layer_name='attention_dense_1',
    #                    visualize_sequence=True)

    # visualize_cam(model, DATASET_INDEX, dataset_prefix='herring', class_id=17)
