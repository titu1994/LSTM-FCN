...
if __name__ == "__main__":
    ...
    #train_model(model, DATASET_INDEX, dataset_prefix='meat', epochs=2000, batch_size=64)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='meat', batch_size=128)

    #visualise_attention(model, DATASET_INDEX, dataset_prefix='meat', layer_name='attention_dense_1',
    #                    visualize_sequence=True)

    # visualize_cam(model, DATASET_INDEX, dataset_prefix='meat', class_id=17)
