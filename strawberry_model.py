...
if __name__ == "__main__":
    ...
    #train_model(model, DATASET_INDEX, dataset_prefix='strawberry', epochs=8000, batch_size=64)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='strawberry', batch_size=64)

    # visualize_context_vector(model, DATASET_INDEX, dataset_prefix='strawberry', visualize_sequence=True,
