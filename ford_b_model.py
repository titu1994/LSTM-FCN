...
if __name__ == "__main__":
    ...
    #train_model(model, DATASET_INDEX, dataset_prefix='ford_b', epochs=1600, batch_size=128)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='ford_b', batch_size=128)

    #visualise_attention(model, DATASET_INDEX, dataset_prefix='ford_b', layer_name='attention_dense_1',
    #                    visualize_sequence=True)

    # visualize_cam(model, DATASET_INDEX, dataset_prefix='ford_b', class_id=17)
