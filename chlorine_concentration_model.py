...
if __name__ == "__main__":
    ...
    #train_model(model, DATASET_INDEX, dataset_prefix='chlorine_concentration', epochs=2000, batch_size=128)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='chlorine_concentration', batch_size=128)

    # visualize_context_vector(model, DATASET_INDEX, dataset_prefix='chlorine_concentration', visualize_sequence=True,
