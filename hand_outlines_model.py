...
if __name__ == "__main__":
    ...
    evaluate_model(model, DATASET_INDEX, dataset_prefix='hand_outlines', batch_size=128)

    #visualise_attention(model, DATASET_INDEX, dataset_prefix='hand_outlines', layer_name='attention_dense_1',
    #                    visualize_sequence=True)

    # visualize_cam(model, DATASET_INDEX, dataset_prefix='hand_outlines', class_id=17)
