...
if __name__ == "__main__":
    ...
    train_model(model, DATASET_INDEX, dataset_prefix='cricket_z', epochs=250, batch_size=64,
                cutoff='post')

    evaluate_model(model, DATASET_INDEX, dataset_prefix='cricket_z', batch_size=64,
                   cutoff='post')

    visualise_attention(model, DATASET_INDEX, dataset_prefix='cricket_z', layer_name='attention_dense_1',
                        cutoff='post')
