...
if __name__ == "__main__":
    ...
    train_model(model, DATASET_INDEX, dataset_prefix='phalanx_age_group', epochs=1000, batch_size=64)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='phalanx_age_group', batch_size=64)
