...
if __name__ == "__main__":
    ...
    #visualise_attention(model, DATASET_INDEX, dataset_prefix='mallat', layer_name='attention_dense_1',
    #                    visualize_sequence=True)

    # visualize_cam(model, DATASET_INDEX, dataset_prefix='mallat', class_id=17)
