...
if __name__ == "__main__":
    ...
    #train_model(model, DATASET_INDEX, dataset_prefix='phalanx_outline', epochs=101, batch_size=128,
    #            val_subset=276)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='phalanx_outline', batch_size=128,
