...
if __name__ == "__main__":
    ...
    # train_model(model, DATASET_INDEX, dataset_prefix='toe_segmentation1', epochs=2000, batch_size=64)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='toe_segmentation1', batch_size=128)

    # visualize_context_vector(model, DATASET_INDEX, dataset_prefix='toe_segmentation1', visualize_sequence=True,
