...
if __name__ == "__main__":
    ...
    #train_model(model, DATASET_INDEX, dataset_prefix='arrowhead', epochs=2000, batch_size=32)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='arrowhead', batch_size=128)

    # visualize_context_vector(model, DATASET_INDEX, dataset_prefix='arrowhead', visualize_sequence=True,
