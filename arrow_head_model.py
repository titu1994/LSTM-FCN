...
def generate_model():
    ...
    model.load_weights("weights/arrowhead_weights - 8800 v3 lstm 8 batch 128 dropout no attention finetuned.h5")
...
if __name__ == "__main__":
    ...
    train_model(model, DATASET_INDEX, dataset_prefix='arrowhead', epochs=1000, batch_size=32)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='arrowhead', batch_size=32)
