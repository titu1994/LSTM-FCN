...
if __name__ == "__main__":
    ...
    # train_model(model, DATASET_INDEX, dataset_prefix='uwave_gesture_library_z', epochs=2000, batch_size=64)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='uwave_gesture_library_z', batch_size=64)

    # visualize_context_vector(model, DATASET_INDEX, dataset_prefix='uwave_gesture_library_z', visualize_sequence=True,
