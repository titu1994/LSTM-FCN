...
if __name__ == "__main__":
    ...
    #train_model(model, DATASET_INDEX, dataset_prefix='ecg200', epochs=2000, batch_size=128)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='ecg200', batch_size=128)

    visualise_attention(model, DATASET_INDEX, dataset_prefix='ecg200', layer_name='attention_dense_1',
