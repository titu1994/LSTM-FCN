...
if __name__ == "__main__":
    ...
    train_model(model, DATASET_INDEX, dataset_prefix='diatomsizereduction', epochs=4000, batch_size=128)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='diatomsizereduction', batch_size=128)
