...
if __name__ == "__main__":
    ...
    evaluate_model(model, DATASET_INDEX, dataset_prefix='large_kitchen_appliances', batch_size=128)

    #visualise_attention(model, DATASET_INDEX, dataset_prefix='large_kitchen_appliances', layer_name='attention_dense_1',
    #                    visualize_sequence=True)

    # visualize_cam(model, DATASET_INDEX, dataset_prefix='large_kitchen_appliances', class_id=17)
