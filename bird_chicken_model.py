...
if __name__ == "__main__":
    ...
    # train_model(model, DATASET_INDEX, dataset_prefix='bird_chicken', epochs=8000, batch_size=64)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='bird_chicken', batch_size=64)

    # visualize_context_vector(model, DATASET_INDEX, dataset_prefix='bird_chicken', visualize_sequence=True,
    #                         visualize_classwise=True, limit=1)

    # visualize_cam(model, DATASET_INDEX, dataset_prefix='bird_chicken', class_id=0)
