...
if __name__ == "__main__":
    ...
    # train_model(model, DATASET_INDEX, dataset_prefix='uwave_gesture_library_y', epochs=2000, batch_size=64)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='uwave_gesture_library_y', batch_size=64)

    # visualize_context_vector(model, DATASET_INDEX, dataset_prefix='uwave_gesture_library_y', visualize_sequence=True,
    #                          visualize_classwise=True, limit=1)

    # visualize_cam(model, DATASET_INDEX, dataset_prefix='uwave_gesture_library_y', class_id=0)
