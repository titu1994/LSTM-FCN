...
if __name__ == "__main__":
    ...
    # visualize_context_vector(model, DATASET_INDEX, dataset_prefix='NonInvasiveFatalECG_Thorax2', visualize_sequence=True,
    #                          visualize_classwise=True, limit=1)

    # visualize_cam(model, DATASET_INDEX, dataset_prefix='NonInvasiveFatalECG_Thorax2', class_id=0)
