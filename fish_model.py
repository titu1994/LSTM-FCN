...
if __name__ == "__main__":
    ...
    #train_model(model, DATASET_INDEX, dataset_prefix='fish', epochs=2000, batch_size=128)

    evaluate_model(model, DATASET_INDEX, dataset_prefix='fish', batch_size=128)

    #visualise_attention(model, DATASET_INDEX, dataset_prefix='fish', layer_name='attention_dense_1',
    #                    visualize_sequence=True)

    # visualize_cam(model, DATASET_INDEX, dataset_prefix='fish', class_id=17)
