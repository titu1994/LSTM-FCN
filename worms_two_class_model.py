...
if __name__ == "__main__":
    ...
    #visualise_attention(model, DATASET_INDEX, dataset_prefix='worms_two_class', layer_name='attention_dense_1',
    #                    visualize_sequence=True)

    # visualize_cam(model, DATASET_INDEX, dataset_prefix='worms_two_class', class_id=17)
