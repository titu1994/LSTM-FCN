...
if __name__ == "__main__":
    ...
    # visualize_context_vector(model, DATASET_INDEX, dataset_prefix='worms_two_class', visualize_sequence=True,
    #                          visualize_classwise=True, limit=1)

    # visualize_cam(model, DATASET_INDEX, dataset_prefix='worms_two_class', class_id=0)
